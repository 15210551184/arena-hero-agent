...
| `--dashboard-memory-file` | `./dashboard-memory.json` | Persist dashboard memory (trajectories, explored cells, resources, system dynamics, event stream) across restarts. |
